...
/** Category of additions for `<CLCoreDatabase>` class.
...
@interface CLCoreDatabase (CLCoreDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `CLCoreResultSet` of schema; `nil` on error.
 
 @see [SQLite File Format](http://www.sqlite.org/fileformat.html)
 */

- (CLCoreResultSet * _Nullable)getSchema;
...
- (CLCoreResultSet * _Nullable)getTableSchema:(NSString*)tableName;
