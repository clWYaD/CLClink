 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `CLCoreModel` protocol for custom methods.
 ...
 Sample Code:
     ...
     ********************** json convertor *********************
 @code
     @interface CLAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation CLAuthor
     @end
 
     @interface CLBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) CLAuthor *author;
     @end
     ...
     int main() {
         ...
         CLBook *book = [CLBook cl_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book cl_modelToJSONString];
 ...
 @code
     @interface CLShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation CLShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self cl_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self cl_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self cl_modelCopy]; }
     - (NSUInteger)hash { return [self cl_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self cl_modelIsEqual:object]; }
     @end
 @endcode
 
 */
@interface NSObject (CLCoreModel)
...
/**
 ...
 There's no need to add '<CLCoreModel>' to your class header.
 */
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
  @code
        @class CLShadow, CLBorder, CLAttachment;
        ...
        @implementation CLAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [CLShadow class],
                     @"borders" : CLBorder.class,
...
/**
 ...
 Example:
 @code
        @class CLCircle, CLRectangle, CLLine;
 
        @implementation CLShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [CLCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [CLRectangle class];
